...
* Debian/Ubuntu/Mint:(https://img.shields.io/badge/Distro-Debian-A81D33?logo=debian&logoColor=white)
  ```bash
...
* Fedora/CentOS/RockyLinux/AlmaLinux/RHEL:
  ```bash
...
*FreeBSD/OpenBSD:
  ```bash
  sudo/doas pkg install python310
  ```
